...
* **Selectable Tone:** Tone is a second axis next to language. Pick **Flirty**, **Shy**, **Dominant**, **Degrading** or **Girlfriend Experience** — or tick several and the app mixes them evenly. Degrading is strictly opt-in and never switches itself on.
