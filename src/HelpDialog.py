...
HELP_TOPICS = [
    ...
    (
        ...
        "your language code (e.g. <code>es</code>), keeping all five tone files inside it.</li>"
        ...
        "event.</li>"
        "<li>Ship every tone. Your tone selection survives a language switch, so a language "
        "that is missing one silently drops it from the mix the moment you switch to it.</li>"
        "</ol>"
