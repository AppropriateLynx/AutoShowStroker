...
CHANGELOG = {
    ...
    "0.10.0": (
        ...
        "<ul>"
        "<li><b>Six tones to pick from:</b> Flirty, Shy, Dominant, Degrading, Degrading "
        "(Hard) and the Girlfriend Experience - the same session, six very different voices "
        "in your ear</li>"
        ...
        "<li>Over 1200 brand-new lines, written from scratch in English, German and French "
        "rather than translated - every tone sounds native in every language</li>"
        "<li>Both Degrading tones are as mean as they sound - the hard one goes after your "
        "size from the first line to the last - and they stay switched off until you tick "
        "them yourself. Nothing turns them on for you</li>"
