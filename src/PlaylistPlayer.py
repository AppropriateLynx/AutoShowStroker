...
class PlaylistPlayer(QStackedWidget):
    ...
    def __init__(self, settings, parent=None):
        ...
        # A QGraphicsVideoItem view rather than a QVideoWidget: the latter renders on a
        # native surface that paints over every sibling widget, which silently swallowed the
        # callouts, the record chase and the clock whenever a clip was on screen. See
        # VideoDisplay for the measured cost of the swap.
